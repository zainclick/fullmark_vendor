...
<div class="col-12 p-3">
	<div class="col-12 col-lg-12 p-0 ">
		...
		<form id="validate-form" class="row" enctype="multipart/form-data" method="POST" action="{{route('admin.grades.store')}}">
		@csrf
		...
		<div class="col-12 p-3">
			...
			<a href="{{route('admin.grades.index')}}" class="btn btn-dark">{{__('main.cancel')}}</a>
		</div> 
		</form>
	</div>
</div>
